import { myntra_Logo } from "../utils/Constant"
    ...
    return(
        <div className="p-4 fixed bg-white flex top-0 items-center  w-[100%] justify-evenly">
            ...
            <div className=" md:flex justify-evenly md:w-[40%]">
                ...
                <div className="mr-2 ml-2"><a href ="/women">WOMEN</a></div>
            ...
            <div className="border-gray-300 border-2 md:mr-6 md:w-[30%]">
                <input type="text"placeholder="search for products.."className="w-full bg-gray-200 text-black opacity-100 p-2"></input>
            </div>
